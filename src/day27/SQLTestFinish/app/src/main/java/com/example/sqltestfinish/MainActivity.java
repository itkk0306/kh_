...
public class MainActivity extends AppCompatActivity {
    ...
    public void queryInfo() {
        ...
        /* try catch 구문을 사용한 이유는
           ...
           이유: goto 는 함수(메서드) 간에 사용이 불가능 하지만
           setjmp() 와 longjmp() 는 저것이 가능하다.

           try 쪽에는 예외 상황이 발생할 수도 이쓴 코드를 적는다.
