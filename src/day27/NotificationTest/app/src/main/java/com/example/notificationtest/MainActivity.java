...
public class MainActivity extends AppCompatActivity {
    ...
    public void showNoti() {
        ...
        /* SDK 버전이 26 보다 높다면 if 문을 만족한다.
           ...
           우리가 초기 프로젝트 생성시 minimum support 를 15로 놨기 때문에
           이 부분은 거짓이 된다.
         */
...
/*
    Input Stream 과 Buffered Stream 은 블로킹에 해당.

    리소스 사용량이 많다는 것 -> CPU 사용량이 많음
    기다리는 상황에서 CPU를 자꾸 쓴다는 것?
    -> EX) 화장실에서 볼일을 보려고 할때
    안에 사람이 있는지 확인하고자 할때 노크를 하게 될 때,
    블로킹은 노크를 계속 하고 있는 경우임.
