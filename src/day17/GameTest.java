...
class Warrior extends Adventurer {
    ...
    public Warrior(float a, float d, float i, float v, float ag, float ang) {
        super(a, d, i, v, ag);
...
class Thief extends Adventurer{
        public Thief(float a, float d, float i, float v, float ag){
            super(a,d,i,v,ag);
        }
    public void skill1() {
...
public class GameTest {
    public static void main(String[] args) {
        ...
        Warrior war = new Warrior(                      70,50,15,40,20,100);

        war.skill1();
        war.skill2();
        war.skill3();

        Thief t = new Thief(45,20,20,25,80);
